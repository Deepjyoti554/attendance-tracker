...
export class AddStudentComponent {
  ...
  studentProfile: FormGroup = this.fb.group({
  ...
  onSubmit() {
    if (this.studentProfile.valid) {
      ...
      // this.api.getFormData(this.studentProfile.value)
      this.api.getFormData(this.studentProfile.value).subscribe();
    } else {
      alert("Form toh bharle");
    }
  }
